...
\begin{itemize}
	...
	\item Data Structures and Algorithms, Programming in C++, Computer Architecture 
	\item Mechanics, Electricity and Magnetism, Thermodynamics and Modern Physics, Classical Mechanics
	\item Graduate Quantum Algorithms (Scheduled)
	\item Graduate Computational Foundations of Artificial Intelligence (Scheduled)
\end{itemize}
\cvsect{CONFERENCES}
\begin{entrylist}
	\entry 
