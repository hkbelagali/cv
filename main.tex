...
Undergraduate computer science major with research interests in molecular dynamics, Monte Carlo methods, quantum optimization algorithms, quantum error correction, and machine learning.\\
\end{minipage}
...
\begin{minipage}[t]{0.465\textwidth}
    ...
    \hfill
    \begin{minipage}[t]{0.73\textwidth}
    	NumPy, PyTorch, MatPlotLib, Qiskit
    \end{minipage}
	\vspace{4mm}
...
\begin{entrylist}
	\entry 
		...
		\begin{itemize}[noitemsep,topsep=0pt,parsep=0pt,partopsep=0pt, leftmargin=7pt]
			...
			\item Analyzed the effect of PDLP-5 (Plasmodesmata Located Protein) on water flow rates through PIP1;4 aquaporin tetramer using grid-steered molecular dynamics. Calculated protein transition kinetics using Markov State Models (MSMs) and transition path theory.
